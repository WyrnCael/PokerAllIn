				...
				// Si son iguales se compara por jugada.
					...
					case 7:
						...
						if(jugada1.getBestCards().get(0).getValue().getValue() > jugada2.getBestCards().get(0).getValue().getValue()){
							...
							if(jugada1.getBestCards().get(4).getValue().getValue() > jugada2.getBestCards().get(4).getValue().getValue()){
								return -1;
							}
							else if(jugada1.getBestCards().get(4).getValue().getValue() < jugada2.getBestCards().get(4).getValue().getValue()){
								return 1;
							}
						}
						return 0;
